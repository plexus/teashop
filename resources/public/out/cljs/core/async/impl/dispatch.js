...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_18282 = (0);while(true){
var m_18283 = cljs.core.async.impl.dispatch.tasks.pop();if((m_18283 == null))
{} else
{m_18283.call(null);
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7932__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7932__auto__)
