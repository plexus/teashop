...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t18288 !== 'undefined')
{} else
{
/**
* @constructor
...
cljs.core.async.impl.channels.t18288.cljs$lang$ctorPrWriter = (function (this__8511__auto__,writer__8512__auto__,opt__8513__auto__){return cljs.core._write.call(null,writer__8512__auto__,"cljs.core.async.impl.channels/t18288");
});
cljs.core.async.impl.channels.t18288.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t18288.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_18290){var self__ = this;
var _18290__$1 = this;return self__.meta18289;
});
cljs.core.async.impl.channels.t18288.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_18290,meta18289__$1){var self__ = this;
var _18290__$1 = this;return (new cljs.core.async.impl.channels.t18288(self__.val,self__.box,meta18289__$1));
});
cljs.core.async.impl.channels.__GT_t18288 = (function __GT_t18288(val__$1,box__$1,meta18289){return (new cljs.core.async.impl.channels.t18288(val__$1,box__$1,meta18289));
});
}
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8514__auto__,writer__8515__auto__,opts__8516__auto__){return cljs.core._write.call(null,writer__8515__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8511__auto__,writer__8512__auto__,opt__8513__auto__){return cljs.core._write.call(null,writer__8512__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_18291 = self__.takes.pop();if((taker_18291 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_18291))
{var take_cb_18292 = cljs.core.async.impl.protocols.commit.call(null,taker_18291);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_18292,taker_18291,this$__$1){
return (function (){return take_cb_18292.call(null,null);
});})(take_cb_18292,taker_18291,this$__$1))
);
} else
{}
{
