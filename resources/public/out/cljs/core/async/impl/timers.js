...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8511__auto__,writer__8512__auto__,opt__8513__auto__){return cljs.core._write.call(null,writer__8512__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_18189 = (0);while(true){
if((i_18189 < arr.length))
{(arr[i_18189] = null);
{
var G__18190 = (i_18189 + (1));
i_18189 = G__18190;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8511__auto__,writer__8512__auto__,opt__8513__auto__){return cljs.core._write.call(null,writer__8512__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_18196 = (self__.level + (1));while(true){
if((i_18196 <= (new_level + (1))))
{(update[i_18196] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_18198 = (0);while(true){
if((i_18198 <= self__.level))
{var links_18199 = (update[i_18198]).forward;if(((links_18199[i_18198]) === x__$1))
{(links_18199[i_18198] = (x__$1.forward[i_18198]));
{
var G__18200 = (i_18198 + (1));
i_18198 = G__18200;
continue;
}
} else
{{
var G__18201 = (i_18198 + (1));
i_18198 = G__18201;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7944__auto__ = (cljs.core.truth_((function (){var and__7932__auto__ = me;if(cljs.core.truth_(and__7932__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7932__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7944__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__7944__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__7944__auto__,timeout__$1,me))
,msecs);
