...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj13821 = {};return obj13821;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7932__auto__ = this$;if(and__7932__auto__)
...
{var x__8571__auto__ = (((this$ == null))?null:this$);return (function (){var or__7944__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__8571__auto__)]);if(or__7944__auto__)
{return or__7944__auto__;
} else
{var or__7944__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7944__auto____$1)
...
return (function (p__13822){var vec__13823 = p__13822;var k = cljs.core.nth.call(null,vec__13823,(0),null);var v = cljs.core.nth.call(null,vec__13823,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__13824){var vec__13825 = p__13824;var k = cljs.core.nth.call(null,vec__13825,(0),null);var v = cljs.core.nth.call(null,vec__13825,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
